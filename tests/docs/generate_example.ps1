...
$CommandsFile = "D:\Sync\repos\els\tests\docs\running_example.ps1"
$exampleMarkdownFile = "D:\Sync\repos\els\tests\docs\running_example.md"
$controlsDir = "D:\Sync\repos\els\tests\docs\controls\"
$CurrentMarkdownFile = ""
