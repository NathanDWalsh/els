...
$CommandsFile = "D:\Sync\repos\eel\tests\docs\running_example.ps1"
$exampleMarkdownFile = "D:\Sync\repos\eel\tests\docs\running_example.md"
$controlsDir = "D:\Sync\repos\eel\tests\docs\controls\"
$CurrentMarkdownFile = ""
